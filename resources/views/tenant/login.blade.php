...
<div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Or
                <a href="{{ route('tenant.register', ['tenant' => $tenant->domain?? $tenant->id]) }}" class="font-medium text-indigo-600 hover:text-indigo-500">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form class="space-y-6" method="POST" action="{{ route('tenant.login', ['tenant' => $tenant->domain?? $tenant->id]) }}">
                @csrf
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white text-gray-500">New to {{ $tenant->name }}?</span>
                    </div>
                </div>

                <div class="mt-6">
                    <a href="{{ route('tenant.register' , ['tenant' => $tenant->domain?? $tenant->id]) }}" 
