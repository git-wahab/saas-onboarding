...
return [
    ...
    /*
     * The path where the landlord migrations will be stored.
     *
     * This path is used by the `landlord:artisan` command to run migrations
     * on the landlord database.
     */
    'landlord_migrations_path' => database_path('migrations/landlord'),
    
    /*
     * The path where the tenant migrations will be stored.
     *
     * This path is used by the `tenant:artisan` command to run migrations
     * on the tenant database.
     */
